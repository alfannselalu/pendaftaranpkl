                                ...
                                <div class="col-md-12">
                                    <div class="p-5">
                                        <div class="text-center mb-2">
                                            <h1 class="h4 mb-5 pt-4 text-xl font-semibold">Add New Admin</h1>
                                        </div>
                                        <form action="/dataAdmin" method="POST" class="user" enctype="multipart/form-data">
                                            @csrf
                                            <div class="mt-3">
                                                <label for="nama_admin" class="form-label">Nama Admin</label>
                                                <input value="{{ old('nama_admin') }}" type="text" class="mt-1 w-full form-control @error('nama_admin') is-invalid @enderror" name="nama_admin" id="nama_admin" required autofocus>
                                                @error('nama_admin')
                                            ...
                                            <button class="btn btn-primary w-100 py-2 mt-3" type="submit">Add Admin</button>
                                    </form>
                                </div>
                            </div>
                        </div>
