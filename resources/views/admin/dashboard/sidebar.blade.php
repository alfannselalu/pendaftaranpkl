            ...
            <div class="navbar-header">
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <span>
                            @if ($admin->image) 
                                <img src="{{ asset('storage/' . $admin->image) }}" alt="{{ $admin->nama_admin }}" class="img-thumbnail rounded-circle" style="width: 2.5rem; height:3rem;"> 
                        ...
                        {{-- @if (Route::has('login'))
                                @auth
                                    @if (auth()->check())
                                        ...
                                        src="{{ asset('storage/' . auth()->admin()->image) }}"
                                        alt="Header Avatar">
                                    @else
                                        <img class="rounded-circle header-profile-user"
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <!-- item-->
                            <a class="dropdown-item" href="/dataAdmin"><i class="bx bx-user font-size-16 align-middle me-1"></i> <span key="t-profile">Profile</span></a>
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="/adminAbsensi" key="t-basic-tables">Data Absensi Siswa</a></li>
                                <li><a href="/dataAdmin" key="t-data-tables">Data AdminPKL</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="/laporan-siswa" class="waves-effect">
                                <i class="fas fa-poll-h"></i>
                                <span key="t-tables">LaporanStatusPKL</span>
                            </a>
                        </li>
                        <li>
                            <a href="/department" class="waves-effect">
                                <i class="bx bx-star"></i>
                                <span key="t-tables">Posisi</span>
                            </a>
                        </li>
                        {{-- <li>
