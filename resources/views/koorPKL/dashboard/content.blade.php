                                        ...
                                        <div class="bg-primary bg-soft">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-5 align-self-end">
                                                    @if ($koor->image) 
                                                    <img src="{{ asset('storage/' . $koor->image) }}" alt="{{ $koor->nama_koor }}" class="img-fluid " style="width: 2.5rem; height:3rem;"> 
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="avatar-md profile-user-wid">
                                                        @if ($koor->image) 
                                                        <img src="{{ asset('storage/' . $koor->image) }}" alt="{{ $koor->nama_koor }}" class="img-thumbnail rounded-circle " style="width: 4rem; height:4rem;"> 
                                                        {{-- @else Tidak ada gambar  --}}
                                                        @endif                                                
                                                    </div>
                                                    @endforeach
                                                    ...
                                                    <div class="pt-4">
                                                        <div class="row">
                                                            <div class="col-9">
                                                                ...
                                                                <p class="text-muted mb-0">{{ Auth::guard('koordinator')->user()->department->posisi }}</p>
                                                            </div>
                                                        </div>
                                                        <div class="mt-4">
